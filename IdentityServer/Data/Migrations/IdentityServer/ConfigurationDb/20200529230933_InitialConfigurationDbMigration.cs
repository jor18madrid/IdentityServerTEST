        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApiClaims_TBLAPITEST_ApiResourceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApiProperties_TBLAPITEST_ApiResourceId",
                        column: x => x.ApiResourceId,
                        principalTable: "TBLAPITEST",
                        principalColumn: "APIID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientClaims_TBLCLIENTES_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientIdPRestrictions_TBLCLIENTES_ClientId",
                        column: x => x.ClientId,
                        principalTable: "TBLCLIENTES",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientProperties_TBLCLIENTES_ClientId",
                        column: x => x.ClientId,
                        principalTable: "TBLCLIENTES",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
